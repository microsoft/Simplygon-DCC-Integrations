...
namespace SimplygonUI.MaxUI.Settings
{
    ...
    [System.Runtime.Serialization.DataContract]
    public class ResetStates : SimplygonSettingsProperty
    {
        bool value;
        [System.Runtime.Serialization.DataMember]
        public bool Value { get { return value; } set { this.value = value; OnPropertyChanged(); } }

        public ResetStates() : base("ResetStates")
        {
            Name = "ResetStates";
            Type = "bool";
            HelpText = "Enabled: Simplygon will automatically reset previously set states (through sgsdk_Reset) to ensure consistent results. Disabled: disable this option to preserve settings and overrides set via script (use with caution!).";
            Visible = true;
    ...
    public class TangentCalculatorType : SimplygonSettingsProperty
    {
        ...
        public override void Reset()
        {
            Value = Simplygon.ETangentSpaceMethod.Autodesk3dsMax;
        }
    }
}
