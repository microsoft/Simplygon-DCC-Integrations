...
template <class _Ty, uint fixedSize = 32 > class FixedArray 
{
	...
	public:
		FixedArray( uint _allocSize ) : allocSize(_allocSize)
		{ 
...
bool Triangulator::TriangulateConcavePolygon( Triangle* destTriangleList, const unsigned int* srcPolygonVertexIds, unsigned int srcPolygonCornerCount ) const
{
	...
	return Triangulator::TriangulateConcavePolygon( destTriangleList , srcPolygonVertexCoords , srcPolygonCornerCount );
}

bool Triangulator::TriangulateConcavePolygon( Triangle* destTriangleList, const vec3* srcPolygonVertexCoords, unsigned int srcPolygonCornerCount )
{
