...
class Triangulator
{
	...
	public:
		...
		//
		bool TriangulatePolygon( Triangle* destTriangleList, const unsigned int* srcPolygonVertexIds, unsigned int srcPolygonCornerCount ) const;
		static bool TriangulatePolygon( Triangle* destTriangleList, const vec3* srcPolygonVertexCoords, unsigned int srcPolygonCornerCount );
	...
	private:
		...
		bool TriangulateConcavePolygon( Triangle* destTriangleList, const unsigned int* srcPolygonVertexIds, unsigned int srcPolygonCornerCount ) const;
		static bool TriangulateConcavePolygon( Triangle* destTriangleList, const vec3* srcPolygonVertexCoords, unsigned int srcPolygonCornerCount );
...
inline bool Triangulator::TriangulatePolygon( Triangle* destTriangleList, const unsigned int* srcPolygonVertexIds, unsigned int srcPolygonCornerCount ) const
{
	...
	return Triangulator::TriangulateConcavePolygon( destTriangleList , srcPolygonVertexIds , srcPolygonCornerCount );
}

inline bool Triangulator::TriangulatePolygon( Triangle* destTriangleList, const vec3* srcPolygonVertexCoords, unsigned int srcPolygonCornerCount )
{
	// check for special cases, with less than 5 corners
	...
	return TriangulateConcavePolygon( destTriangleList , srcPolygonVertexCoords , srcPolygonCornerCount );
}
